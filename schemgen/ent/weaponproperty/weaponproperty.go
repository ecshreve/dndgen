...
const (
	// Label holds the string label denoting the weaponproperty type in the database.
	...
	EdgeWeapons = "weapons"
	// Table holds the table name of the weaponproperty in the database.
...
// Columns holds all SQL columns for weaponproperty fields.
var Columns = []string{
	FieldID,
	FieldIndx,
	FieldName,
...
var (
	...
	WeaponsPrimaryKey = []string{"weapon_id", "weapon_property_id"}
)
...
// OrderOption defines the ordering options for the WeaponProperty queries.
