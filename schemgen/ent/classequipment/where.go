...
func ClassID(v int) predicate.ClassEquipment {
	return predicate.ClassEquipment(sql.FieldEQ(FieldClassID, v))
}
...
func EquipmentID(v int) predicate.ClassEquipment {
	return predicate.ClassEquipment(sql.FieldEQ(FieldEquipmentID, v))
}

// Quantity applies equality check predicate on the "quantity" field. It's identical to QuantityEQ.
func Quantity(v int) predicate.ClassEquipment {
	return predicate.ClassEquipment(sql.FieldEQ(FieldQuantity, v))
}
...
func EquipmentIDNEQ(v int) predicate.ClassEquipment {
	return predicate.ClassEquipment(sql.FieldNEQ(FieldEquipmentID, v))
}

// EquipmentIDIn applies the In predicate on the "equipment_id" field.
func EquipmentIDIn(vs ...int) predicate.ClassEquipment {
	return predicate.ClassEquipment(sql.FieldIn(FieldEquipmentID, vs...))
}
...
func EquipmentIDNotIn(vs ...int) predicate.ClassEquipment {
	return predicate.ClassEquipment(sql.FieldNotIn(FieldEquipmentID, vs...))
}
...
func QuantityNEQ(v int) predicate.ClassEquipment {
	return predicate.ClassEquipment(sql.FieldNEQ(FieldQuantity, v))
}

// QuantityIn applies the In predicate on the "quantity" field.
func QuantityIn(vs ...int) predicate.ClassEquipment {
	return predicate.ClassEquipment(sql.FieldIn(FieldQuantity, vs...))
}

// QuantityNotIn applies the NotIn predicate on the "quantity" field.
func QuantityNotIn(vs ...int) predicate.ClassEquipment {
	return predicate.ClassEquipment(sql.FieldNotIn(FieldQuantity, vs...))
}

// QuantityGT applies the GT predicate on the "quantity" field.
func QuantityGT(v int) predicate.ClassEquipment {
	return predicate.ClassEquipment(sql.FieldGT(FieldQuantity, v))
}

// QuantityGTE applies the GTE predicate on the "quantity" field.
func QuantityGTE(v int) predicate.ClassEquipment {
	return predicate.ClassEquipment(sql.FieldGTE(FieldQuantity, v))
}

// QuantityLT applies the LT predicate on the "quantity" field.
func QuantityLT(v int) predicate.ClassEquipment {
	return predicate.ClassEquipment(sql.FieldLT(FieldQuantity, v))
}

// QuantityLTE applies the LTE predicate on the "quantity" field.
func QuantityLTE(v int) predicate.ClassEquipment {
	return predicate.ClassEquipment(sql.FieldLTE(FieldQuantity, v))
}

// HasClass applies the HasEdge predicate on the "class" edge.
func HasClass() predicate.ClassEquipment {
	return predicate.ClassEquipment(func(s *sql.Selector) {
...
func And(predicates ...predicate.ClassEquipment) predicate.ClassEquipment {
	return predicate.ClassEquipment(func(s *sql.Selector) {
		s1 := s.Clone().SetP(nil)
...
func Or(predicates ...predicate.ClassEquipment) predicate.ClassEquipment {
	return predicate.ClassEquipment(func(s *sql.Selector) {
		s1 := s.Clone().SetP(nil)
...
func Not(p predicate.ClassEquipment) predicate.ClassEquipment {
	return predicate.ClassEquipment(func(s *sql.Selector) {
		p(s.Not())
	})
}
