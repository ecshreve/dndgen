...
func (ecu *EquipmentCostUpdate) check() error {
	if _, ok := ecu.mutation.EquipmentID(); ecu.mutation.EquipmentCleared() && !ok {
		return errors.New(`ent: clearing a required unique edge "EquipmentCost.equipment"`)
	}
	if _, ok := ecu.mutation.CoinID(); ecu.mutation.CoinCleared() && !ok {
...
func (ecu *EquipmentCostUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := ecu.mutation.GpValue(); ok {
		_spec.SetField(equipmentcost.FieldGpValue, field.TypeFloat64, value)
	}
	if value, ok := ecu.mutation.AddedGpValue(); ok {
		_spec.AddField(equipmentcost.FieldGpValue, field.TypeFloat64, value)
	}
...
// SetGpValue sets the "gp_value" field.
func (ecuo *EquipmentCostUpdateOne) SetGpValue(f float64) *EquipmentCostUpdateOne {
	ecuo.mutation.ResetGpValue()
	ecuo.mutation.SetGpValue(f)
	return ecuo
}

// AddGpValue adds f to the "gp_value" field.
func (ecuo *EquipmentCostUpdateOne) AddGpValue(f float64) *EquipmentCostUpdateOne {
	ecuo.mutation.AddGpValue(f)
	return ecuo
}
...
func (ecuo *EquipmentCostUpdateOne) check() error {
	if _, ok := ecuo.mutation.EquipmentID(); ecuo.mutation.EquipmentCleared() && !ok {
		return errors.New(`ent: clearing a required unique edge "EquipmentCost.equipment"`)
	}
	if _, ok := ecuo.mutation.CoinID(); ecuo.mutation.CoinCleared() && !ok {
		return errors.New(`ent: clearing a required unique edge "EquipmentCost.coin"`)
	}
	return nil
}
...
func (ecuo *EquipmentCostUpdateOne) sqlSave(ctx context.Context) (_node *EquipmentCost, err error) {
	...
	if value, ok := ecuo.mutation.GpValue(); ok {
		_spec.SetField(equipmentcost.FieldGpValue, field.TypeFloat64, value)
	}
	if value, ok := ecuo.mutation.AddedGpValue(); ok {
		_spec.AddField(equipmentcost.FieldGpValue, field.TypeFloat64, value)
	}
