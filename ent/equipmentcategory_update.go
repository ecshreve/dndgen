...
func (ecu *EquipmentCategoryUpdate) SetIndx(e equipmentcategory.Indx) *EquipmentCategoryUpdate {
	ecu.mutation.SetIndx(e)
	return ecu
}

// SetNillableIndx sets the "indx" field if the given value is not nil.
func (ecu *EquipmentCategoryUpdate) SetNillableIndx(e *equipmentcategory.Indx) *EquipmentCategoryUpdate {
	if e != nil {
		ecu.SetIndx(*e)
	}
	return ecu
...
func (ecu *EquipmentCategoryUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := ecu.mutation.Indx(); ok {
		_spec.SetField(equipmentcategory.FieldIndx, field.TypeEnum, value)
	}
...
// SetIndx sets the "indx" field.
func (ecuo *EquipmentCategoryUpdateOne) SetIndx(e equipmentcategory.Indx) *EquipmentCategoryUpdateOne {
	ecuo.mutation.SetIndx(e)
	return ecuo
}

// SetNillableIndx sets the "indx" field if the given value is not nil.
func (ecuo *EquipmentCategoryUpdateOne) SetNillableIndx(e *equipmentcategory.Indx) *EquipmentCategoryUpdateOne {
	if e != nil {
		ecuo.SetIndx(*e)
	}
	return ecuo
