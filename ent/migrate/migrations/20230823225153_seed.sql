...
CREATE TABLE `armor_classes` (
  ...
  `max_bonus` integer NULL,
  `armor_armor_class` integer NULL,
  CONSTRAINT `armor_classes_armors_armor_class` FOREIGN KEY (`armor_armor_class`) REFERENCES `armors` (`id`) ON DELETE
  SET
    NULL
);
...
CREATE TABLE `damage_types` (
  ...
  `name` text NOT NULL,
  `desc` json NOT NULL,
  `weapon_damage_damage_type` integer NULL,
  CONSTRAINT `damage_types_weapon_damages_damage_type` FOREIGN KEY (`weapon_damage_damage_type`) REFERENCES `weapon_damages` (`id`) ON DELETE
  SET
    NULL
);
...
CREATE TABLE `equipment` (
  ...
  `equipment_weapon` integer NULL,
  `equipment_armor` integer NULL,
  `equipment_gear` integer NULL,
  `equipment_tool` integer NULL,
  `equipment_vehicle` integer NULL,
  `equipment_cost` integer NULL,
  CONSTRAINT `equipment_weapons_weapon` FOREIGN KEY (`equipment_weapon`) REFERENCES `weapons` (`id`) ON DELETE
  SET
    NULL,
    CONSTRAINT `equipment_armors_armor` FOREIGN KEY (`equipment_armor`) REFERENCES `armors` (`id`) ON DELETE
  SET
    NULL,
    CONSTRAINT `equipment_gears_gear` FOREIGN KEY (`equipment_gear`) REFERENCES `gears` (`id`) ON DELETE
  SET
    NULL,
    CONSTRAINT `equipment_tools_tool` FOREIGN KEY (`equipment_tool`) REFERENCES `tools` (`id`) ON DELETE
  SET
    NULL,
    CONSTRAINT `equipment_vehicles_vehicle` FOREIGN KEY (`equipment_vehicle`) REFERENCES `vehicles` (`id`) ON DELETE
  SET
    NULL,
    CONSTRAINT `equipment_costs_cost` FOREIGN KEY (`equipment_cost`) REFERENCES `costs` (`id`) ON DELETE
  SET
    NULL
);
...
CREATE TABLE `languages` (
  ...
  `name` text NOT NULL,
  `desc` text NOT NULL,
  `language_type` text NOT NULL DEFAULT 'STANDARD',
  `script` text NULL DEFAULT 'Common'
);
...
CREATE TABLE `proficiencies` (
  ...
  `indx` text NOT NULL,
  `name` text NOT NULL,
  `proficiency_category` text NOT NULL DEFAULT 'other'
);
...
CREATE TABLE `skills` (
  ...
  CONSTRAINT `skills_ability_scores_ability_score` FOREIGN KEY (`ability_score_id`) REFERENCES `ability_scores` (`id`) ON DELETE NO ACTION
);
...
CREATE TABLE `class_saving_throws` (
  ...
  CONSTRAINT `class_saving_throws_class_id` FOREIGN KEY (`class_id`) REFERENCES `classes` (`id`) ON DELETE CASCADE,
  CONSTRAINT `class_saving_throws_ability_score_id` FOREIGN KEY (`ability_score_id`) REFERENCES `ability_scores` (`id`) ON DELETE CASCADE
);
...
CREATE TABLE `proficiency_classes` (
  ...
  `class_id` integer NOT NULL,
  PRIMARY KEY (`proficiency_id`, `class_id`),
  CONSTRAINT `proficiency_classes_proficiency_id` FOREIGN KEY (`proficiency_id`) REFERENCES `proficiencies` (`id`) ON DELETE CASCADE,
  CONSTRAINT `proficiency_classes_class_id` FOREIGN KEY (`class_id`) REFERENCES `classes` (`id`) ON DELETE CASCADE
);
...
CREATE TABLE `proficiency_races` (
  ...
  PRIMARY KEY (`proficiency_id`, `race_id`),
  CONSTRAINT `proficiency_races_proficiency_id` FOREIGN KEY (`proficiency_id`) REFERENCES `proficiencies` (`id`) ON DELETE CASCADE,
  CONSTRAINT `proficiency_races_race_id` FOREIGN KEY (`race_id`) REFERENCES `races` (`id`) ON DELETE CASCADE
);
...
CREATE TABLE `race_languages` (
  ...
  CONSTRAINT `race_languages_race_id` FOREIGN KEY (`race_id`) REFERENCES `races` (`id`) ON DELETE CASCADE,
  CONSTRAINT `race_languages_language_id` FOREIGN KEY (`language_id`) REFERENCES `languages` (`id`) ON DELETE CASCADE
);
