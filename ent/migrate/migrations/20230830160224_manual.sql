...
INSERT INTO sqlite_sequence (name, seq) VALUES ("races", 51539607552);
...
INSERT INTO sqlite_sequence (name, seq) VALUES ("rules", 55834574848);
...
INSERT INTO sqlite_sequence (name, seq) VALUES ("rule_sections", 60129542144);
...
INSERT INTO sqlite_sequence (name, seq) VALUES ("skills", 64424509440);
-- Create index "skills_indx_key" to table: "skills"
CREATE UNIQUE INDEX `skills_indx_key` ON `skills` (`indx`);
-- Create "subraces" table
CREATE TABLE `subraces` (`id` integer NOT NULL PRIMARY KEY AUTOINCREMENT, `indx` text NOT NULL, `name` text NOT NULL, `desc` text NOT NULL, `race_subrace` integer NULL, CONSTRAINT `subraces_races_subrace` FOREIGN KEY (`race_subrace`) REFERENCES `races` (`id`) ON DELETE SET NULL);
-- Set sequence for "subraces" table
INSERT INTO sqlite_sequence (name, seq) VALUES ("subraces", 68719476736);
...
INSERT INTO sqlite_sequence (name, seq) VALUES ("tools", 73014444032);
...
INSERT INTO sqlite_sequence (name, seq) VALUES ("traits", 77309411328);
...
INSERT INTO sqlite_sequence (name, seq) VALUES ("vehicles", 81604378624);
...
INSERT INTO sqlite_sequence (name, seq) VALUES ("weapons", 85899345920);
...
INSERT INTO sqlite_sequence (name, seq) VALUES ("weapon_damages", 90194313216);
...
INSERT INTO sqlite_sequence (name, seq) VALUES ("weapon_properties", 94489280512);
...
-- Add pk ranges for ('ability_bonus'),('ability_scores'),('armors'),('armor_classes'),('classes'),('costs'),('damage_types'),('equipment'),('gears'),('languages'),('magic_schools'),('proficiencies'),('races'),('rules'),('rule_sections'),('skills'),('subraces'),('tools'),('traits'),('vehicles'),('weapons'),('weapon_damages'),('weapon_properties') tables
INSERT INTO `ent_types` (`type`) VALUES ('ability_bonus'), ('ability_scores'), ('armors'), ('armor_classes'), ('classes'), ('costs'), ('damage_types'), ('equipment'), ('gears'), ('languages'), ('magic_schools'), ('proficiencies'), ('races'), ('rules'), ('rule_sections'), ('skills'), ('subraces'), ('tools'), ('traits'), ('vehicles'), ('weapons'), ('weapon_damages'), ('weapon_properties');
