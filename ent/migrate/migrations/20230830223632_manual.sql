...
CREATE TABLE `new_choices` (`id` integer NOT NULL PRIMARY KEY AUTOINCREMENT, `choose` integer NOT NULL, `desc` text NULL, `choice_from` integer NULL, CONSTRAINT `choices_races_from` FOREIGN KEY (`choice_from`) REFERENCES `races` (`id`) ON DELETE SET NULL);
