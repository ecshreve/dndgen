...
func (acu *ArmorClassUpdate) SetNillableBase(i *int) *ArmorClassUpdate {
	if i != nil {
		acu.SetBase(*i)
	}
	return acu
...
func (acu *ArmorClassUpdate) SetNillableDexBonus(b *bool) *ArmorClassUpdate {
	if b != nil {
		acu.SetDexBonus(*b)
	}
	return acu
...
func (acu *ArmorClassUpdate) SetArmorID(id int) *ArmorClassUpdate {
	acu.mutation.SetArmorID(id)
	return acu
}

// SetNillableArmorID sets the "armor" edge to the Armor entity by ID if the given value is not nil.
func (acu *ArmorClassUpdate) SetNillableArmorID(id *int) *ArmorClassUpdate {
	if id != nil {
		acu = acu.SetArmorID(*id)
	}
	return acu
}

// SetArmor sets the "armor" edge to the Armor entity.
func (acu *ArmorClassUpdate) SetArmor(a *Armor) *ArmorClassUpdate {
	return acu.SetArmorID(a.ID)
}
...
func (acu *ArmorClassUpdate) ClearArmor() *ArmorClassUpdate {
	acu.mutation.ClearArmor()
	return acu
}
...
func (acu *ArmorClassUpdate) check() error {
	if v, ok := acu.mutation.Base(); ok {
...
func (acu *ArmorClassUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if nodes := acu.mutation.ArmorIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2O,
			Inverse: true,
			Table:   armorclass.ArmorTable,
...
// SetNillableBase sets the "base" field if the given value is not nil.
func (acuo *ArmorClassUpdateOne) SetNillableBase(i *int) *ArmorClassUpdateOne {
	if i != nil {
		acuo.SetBase(*i)
	}
	return acuo
...
// SetNillableDexBonus sets the "dex_bonus" field if the given value is not nil.
func (acuo *ArmorClassUpdateOne) SetNillableDexBonus(b *bool) *ArmorClassUpdateOne {
	if b != nil {
		acuo.SetDexBonus(*b)
	}
	return acuo
...
// SetArmorID sets the "armor" edge to the Armor entity by ID.
func (acuo *ArmorClassUpdateOne) SetArmorID(id int) *ArmorClassUpdateOne {
	acuo.mutation.SetArmorID(id)
	return acuo
}

// SetNillableArmorID sets the "armor" edge to the Armor entity by ID if the given value is not nil.
func (acuo *ArmorClassUpdateOne) SetNillableArmorID(id *int) *ArmorClassUpdateOne {
	if id != nil {
		acuo = acuo.SetArmorID(*id)
	}
	return acuo
}

// SetArmor sets the "armor" edge to the Armor entity.
func (acuo *ArmorClassUpdateOne) SetArmor(a *Armor) *ArmorClassUpdateOne {
	return acuo.SetArmorID(a.ID)
}
...
// ClearArmor clears the "armor" edge to the Armor entity.
func (acuo *ArmorClassUpdateOne) ClearArmor() *ArmorClassUpdateOne {
	acuo.mutation.ClearArmor()
	return acuo
}
...
// check runs all checks and user-defined validators on the builder.
func (acuo *ArmorClassUpdateOne) check() error {
	if v, ok := acuo.mutation.Base(); ok {
		if err := armorclass.BaseValidator(v); err != nil {
			return &ValidationError{Name: "base", err: fmt.Errorf(`ent: validator failed for field "ArmorClass.base": %w`, err)}
		}
	}
...
func (acuo *ArmorClassUpdateOne) sqlSave(ctx context.Context) (_node *ArmorClass, err error) {
	...
	if nodes := acuo.mutation.ArmorIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2O,
			Inverse: true,
			Table:   armorclass.ArmorTable,
