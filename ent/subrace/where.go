...
func HasLanguageOptions() predicate.Subrace {
	return predicate.Subrace(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasLanguageOptionsWith(preds ...predicate.LanguageChoice) predicate.Subrace {
	return predicate.Subrace(func(s *sql.Selector) {
		step := newLanguageOptionsStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
...
func And(predicates ...predicate.Subrace) predicate.Subrace {
	return predicate.Subrace(sql.AndPredicates(predicates...))
}

// Or groups predicates with the OR operator between them.
func Or(predicates ...predicate.Subrace) predicate.Subrace {
	return predicate.Subrace(sql.OrPredicates(predicates...))
}

// Not applies the not operator on the given predicate.
func Not(p predicate.Subrace) predicate.Subrace {
	return predicate.Subrace(sql.NotPredicates(p))
}
