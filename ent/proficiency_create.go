...
func (pc *ProficiencyCreate) SetCategory(s string) *ProficiencyCreate {
...
func (pc *ProficiencyCreate) check() error {
	...
	if _, ok := pc.mutation.Category(); !ok {
		return &ValidationError{Name: "category", err: errors.New(`ent: missing required field "Proficiency.category"`)}
	}
