...
func (wrc *WeaponRangeCreate) SetRangeNormal(i int) *WeaponRangeCreate {
	wrc.mutation.SetRangeNormal(i)
	return wrc
}

// SetNillableRangeNormal sets the "range_normal" field if the given value is not nil.
func (wrc *WeaponRangeCreate) SetNillableRangeNormal(i *int) *WeaponRangeCreate {
	if i != nil {
		wrc.SetRangeNormal(*i)
	}
	return wrc
}

// SetRangeLong sets the "range_long" field.
func (wrc *WeaponRangeCreate) SetRangeLong(i int) *WeaponRangeCreate {
	wrc.mutation.SetRangeLong(i)
	return wrc
}

// SetNillableRangeLong sets the "range_long" field if the given value is not nil.
func (wrc *WeaponRangeCreate) SetNillableRangeLong(i *int) *WeaponRangeCreate {
	if i != nil {
		wrc.SetRangeLong(*i)
	}
	return wrc
...
func (wrc *WeaponRangeCreate) SetThrowRangeNormal(i int) *WeaponRangeCreate {
	wrc.mutation.SetThrowRangeNormal(i)
	return wrc
}

// SetNillableThrowRangeNormal sets the "throw_range_normal" field if the given value is not nil.
func (wrc *WeaponRangeCreate) SetNillableThrowRangeNormal(i *int) *WeaponRangeCreate {
	if i != nil {
		wrc.SetThrowRangeNormal(*i)
	}
	return wrc
}

// SetThrowRangeLong sets the "throw_range_long" field.
func (wrc *WeaponRangeCreate) SetThrowRangeLong(i int) *WeaponRangeCreate {
	wrc.mutation.SetThrowRangeLong(i)
	return wrc
}

// SetNillableThrowRangeLong sets the "throw_range_long" field if the given value is not nil.
func (wrc *WeaponRangeCreate) SetNillableThrowRangeLong(i *int) *WeaponRangeCreate {
	if i != nil {
		wrc.SetThrowRangeLong(*i)
	}
	return wrc
}
