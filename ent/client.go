...
// QueryProficiencyChoice queries the proficiency_choice edge of a Proficiency.
func (c *ProficiencyClient) QueryProficiencyChoice(pr *Proficiency) *ProficiencyChoiceQuery {
	query := (&ProficiencyChoiceClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := pr.ID
		step := sqlgraph.NewStep(
...
// QueryOptions queries the options edge of a ProficiencyChoice.
func (c *ProficiencyChoiceClient) QueryOptions(pc *ProficiencyChoice) *ProficiencyQuery {
	query := (&ProficiencyClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := pc.ID
		step := sqlgraph.NewStep(
...
func (c *RaceClient) QueryStartingProficiencyOption(r *Race) *ProficiencyChoiceQuery {
	query := (&ProficiencyChoiceClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := r.ID
		step := sqlgraph.NewStep(
