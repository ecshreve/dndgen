...
func (su *SubraceUpdate) SetNillableIndx(s *string) *SubraceUpdate {
	if s != nil {
		su.SetIndx(*s)
	}
	return su
...
func (su *SubraceUpdate) SetNillableName(s *string) *SubraceUpdate {
	if s != nil {
		su.SetName(*s)
	}
	return su
...
func (su *SubraceUpdate) AppendDesc(s []string) *SubraceUpdate {
...
func (su *SubraceUpdate) AddLanguageOptionIDs(ids ...int) *SubraceUpdate {
	su.mutation.AddLanguageOptionIDs(ids...)
	return su
}

// AddLanguageOptions adds the "language_options" edges to the LanguageChoice entity.
func (su *SubraceUpdate) AddLanguageOptions(l ...*LanguageChoice) *SubraceUpdate {
	ids := make([]int, len(l))
	for i := range l {
		ids[i] = l[i].ID
	}
	return su.AddLanguageOptionIDs(ids...)
}
...
// ClearLanguageOptions clears all "language_options" edges to the LanguageChoice entity.
func (su *SubraceUpdate) ClearLanguageOptions() *SubraceUpdate {
	su.mutation.ClearLanguageOptions()
	return su
}

// RemoveLanguageOptionIDs removes the "language_options" edge to LanguageChoice entities by IDs.
func (su *SubraceUpdate) RemoveLanguageOptionIDs(ids ...int) *SubraceUpdate {
	su.mutation.RemoveLanguageOptionIDs(ids...)
	return su
}

// RemoveLanguageOptions removes "language_options" edges to LanguageChoice entities.
func (su *SubraceUpdate) RemoveLanguageOptions(l ...*LanguageChoice) *SubraceUpdate {
	ids := make([]int, len(l))
	for i := range l {
		ids[i] = l[i].ID
	}
	return su.RemoveLanguageOptionIDs(ids...)
}
...
func (su *SubraceUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := su.mutation.Desc(); ok {
		_spec.SetField(subrace.FieldDesc, field.TypeJSON, value)
	}
	if value, ok := su.mutation.AppendedDesc(); ok {
		_spec.AddModifier(func(u *sql.UpdateBuilder) {
			sqljson.Append(u, subrace.FieldDesc, value)
		})
	}
	...
	if su.mutation.AbilityBonusesCleared() {
		edge := &sqlgraph.EdgeSpec{
			...
			Columns: subrace.AbilityBonusesPrimaryKey,
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
	...
	if su.mutation.LanguageOptionsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   subrace.LanguageOptionsTable,
			Columns: []string{subrace.LanguageOptionsColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
	...
	if nodes := su.mutation.RemovedLanguageOptionsIDs(); len(nodes) > 0 && !su.mutation.LanguageOptionsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   subrace.LanguageOptionsTable,
	...
	if nodes := su.mutation.LanguageOptionsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   subrace.LanguageOptionsTable,
...
// SetNillableIndx sets the "indx" field if the given value is not nil.
func (suo *SubraceUpdateOne) SetNillableIndx(s *string) *SubraceUpdateOne {
	if s != nil {
		suo.SetIndx(*s)
	}
	return suo
...
// SetNillableName sets the "name" field if the given value is not nil.
func (suo *SubraceUpdateOne) SetNillableName(s *string) *SubraceUpdateOne {
	if s != nil {
		suo.SetName(*s)
	}
	return suo
...
// AppendDesc appends s to the "desc" field.
func (suo *SubraceUpdateOne) AppendDesc(s []string) *SubraceUpdateOne {
...
// AddLanguageOptionIDs adds the "language_options" edge to the LanguageChoice entity by IDs.
func (suo *SubraceUpdateOne) AddLanguageOptionIDs(ids ...int) *SubraceUpdateOne {
	suo.mutation.AddLanguageOptionIDs(ids...)
	return suo
}

// AddLanguageOptions adds the "language_options" edges to the LanguageChoice entity.
func (suo *SubraceUpdateOne) AddLanguageOptions(l ...*LanguageChoice) *SubraceUpdateOne {
	ids := make([]int, len(l))
	for i := range l {
		ids[i] = l[i].ID
	}
	return suo.AddLanguageOptionIDs(ids...)
}
...
// ClearLanguageOptions clears all "language_options" edges to the LanguageChoice entity.
func (suo *SubraceUpdateOne) ClearLanguageOptions() *SubraceUpdateOne {
	suo.mutation.ClearLanguageOptions()
	return suo
}

// RemoveLanguageOptionIDs removes the "language_options" edge to LanguageChoice entities by IDs.
func (suo *SubraceUpdateOne) RemoveLanguageOptionIDs(ids ...int) *SubraceUpdateOne {
	suo.mutation.RemoveLanguageOptionIDs(ids...)
	return suo
}

// RemoveLanguageOptions removes "language_options" edges to LanguageChoice entities.
func (suo *SubraceUpdateOne) RemoveLanguageOptions(l ...*LanguageChoice) *SubraceUpdateOne {
	ids := make([]int, len(l))
	for i := range l {
		ids[i] = l[i].ID
	}
	return suo.RemoveLanguageOptionIDs(ids...)
}
...
func (suo *SubraceUpdateOne) sqlSave(ctx context.Context) (_node *Subrace, err error) {
	...
	if suo.mutation.LanguageOptionsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   subrace.LanguageOptionsTable,
	...
	if nodes := suo.mutation.RemovedLanguageOptionsIDs(); len(nodes) > 0 && !suo.mutation.LanguageOptionsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   subrace.LanguageOptionsTable,
	...
	if nodes := suo.mutation.LanguageOptionsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   subrace.LanguageOptionsTable,
