...
const (
	// Label holds the string label denoting the magicitem type in the database.
	Label = "magic_item"
	...
	// Table holds the table name of the magicitem in the database.
	Table = "magic_items"
	// EquipmentTable is the table that holds the equipment relation/edge. The primary key declared below.
	EquipmentTable = "equipment_magic_item"
	// EquipmentInverseTable is the table name for the Equipment entity.
	// It exists in this package in order to avoid circular dependency with the "equipment" package.
	EquipmentInverseTable = "equipment"
)

// Columns holds all SQL columns for magicitem fields.
var Columns = []string{
	FieldID,
	FieldRarity,
}
...
var (
	...
	EquipmentPrimaryKey = []string{"equipment_id", "magic_item_id"}
)
...
// OrderOption defines the ordering options for the MagicItem queries.
