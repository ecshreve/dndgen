...
const (
	// Label holds the string label denoting the startingequipment type in the database.
	...
	EquipmentFieldID = "id"
	// Table holds the table name of the startingequipment in the database.
	Table = "starting_equipments"
	...
	EquipmentTable = "starting_equipments"
...
// Columns holds all SQL columns for startingequipment fields.
var Columns = []string{
	FieldClassID,
	FieldEquipmentID,
	FieldQuantity,
...
// OrderOption defines the ordering options for the StartingEquipment queries.
