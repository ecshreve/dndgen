...
export type RaceDetailsFragment = { __typename?: 'Race', id: string, indx: string, name: string, ageDesc: string, alignmentDesc: string, size: RaceSize, sizeDesc: string, speed: number, languageDesc: string, startingProficiencies?: Array<{ __typename?: 'Proficiency', id: string, indx: string, reference: string }> | null, startingProficiencyOptions?: { __typename?: 'ProficiencyChoice', id: string, desc: Array<string>, choose: number, proficiencies?: Array<{ __typename?: 'Proficiency', id: string, indx: string, reference: string }> | null } | null } & { ' $fragmentName'?: 'RaceDetailsFragment' };
