...
export type AbilityBonus = Node & {
  __typename?: 'AbilityBonus';
  abilityScore: AbilityScore;
  bonus: Scalars['Int']['output'];
  id: Scalars['ID']['output'];
  options?: Maybe<Array<AbilityBonusChoice>>;
  race?: Maybe<Array<Race>>;
  subrace?: Maybe<Array<Subrace>>;
};

export type AbilityBonusChoice = Node & {
  __typename?: 'AbilityBonusChoice';
  abilityBonuses?: Maybe<Array<AbilityBonus>>;
...
/**
 * AbilityBonusChoiceWhereInput is used for filtering AbilityBonusChoice objects.
 * Input was generated by ent.
 */
export type AbilityBonusChoiceWhereInput = {
  and?: InputMaybe<Array<AbilityBonusChoiceWhereInput>>;
  ...
  hasAbilityBonusesWith?: InputMaybe<Array<AbilityBonusWhereInput>>;
  ...
  not?: InputMaybe<AbilityBonusChoiceWhereInput>;
  or?: InputMaybe<Array<AbilityBonusChoiceWhereInput>>;
};
 ...
 * Input was generated by ent.
 */
export type AbilityBonusWhereInput = {
  and?: InputMaybe<Array<AbilityBonusWhereInput>>;
  /** bonus field predicates */
  bonus?: InputMaybe<Scalars['Int']['input']>;
  bonusGT?: InputMaybe<Scalars['Int']['input']>;
  bonusGTE?: InputMaybe<Scalars['Int']['input']>;
  bonusIn?: InputMaybe<Array<Scalars['Int']['input']>>;
  bonusLT?: InputMaybe<Scalars['Int']['input']>;
  bonusLTE?: InputMaybe<Scalars['Int']['input']>;
  bonusNEQ?: InputMaybe<Scalars['Int']['input']>;
  bonusNotIn?: InputMaybe<Array<Scalars['Int']['input']>>;
  ...
  hasOptionsWith?: InputMaybe<Array<AbilityBonusChoiceWhereInput>>;
  /** race edge predicates */
  hasRace?: InputMaybe<Scalars['Boolean']['input']>;
  hasRaceWith?: InputMaybe<Array<RaceWhereInput>>;
  /** subrace edge predicates */
  hasSubrace?: InputMaybe<Scalars['Boolean']['input']>;
  hasSubraceWith?: InputMaybe<Array<SubraceWhereInput>>;
  /** id field predicates */
  id?: InputMaybe<Scalars['ID']['input']>;
  idGT?: InputMaybe<Scalars['ID']['input']>;
  idGTE?: InputMaybe<Scalars['ID']['input']>;
  ...
  idNEQ?: InputMaybe<Scalars['ID']['input']>;
  idNotIn?: InputMaybe<Array<Scalars['ID']['input']>>;
  not?: InputMaybe<AbilityBonusWhereInput>;
  or?: InputMaybe<Array<AbilityBonusWhereInput>>;
};
...
export type Race = Node & {
  __typename?: 'Race';
  abilityBonusOptions?: Maybe<AbilityBonusChoice>;
  abilityBonuses?: Maybe<Array<AbilityBonus>>;
...
export type RaceWhereInput = {
  ...
  hasAbilityBonusOptions?: InputMaybe<Scalars['Boolean']['input']>;
  hasAbilityBonusOptionsWith?: InputMaybe<Array<AbilityBonusChoiceWhereInput>>;
  /** ability_bonuses edge predicates */
  hasAbilityBonuses?: InputMaybe<Scalars['Boolean']['input']>;
  hasAbilityBonusesWith?: InputMaybe<Array<AbilityBonusWhereInput>>;
  /** characters edge predicates */
  ...
  hasSubraces?: InputMaybe<Scalars['Boolean']['input']>;
  hasSubracesWith?: InputMaybe<Array<SubraceWhereInput>>;
...
export type Subrace = Node & {
  __typename?: 'Subrace';
  abilityBonuses?: Maybe<Array<AbilityBonus>>;
  desc: Array<Scalars['String']['output']>;
  id: Scalars['ID']['output'];
  indx: Scalars['String']['output'];
  languageOptions?: Maybe<Array<LanguageChoice>>;
  name: Scalars['String']['output'];
  proficiencies?: Maybe<Array<Proficiency>>;
  race?: Maybe<Race>;
  traits?: Maybe<Array<Trait>>;
...
export type SubraceWhereInput = {
  and?: InputMaybe<Array<SubraceWhereInput>>;
  /** ability_bonuses edge predicates */
  hasAbilityBonuses?: InputMaybe<Scalars['Boolean']['input']>;
  hasAbilityBonusesWith?: InputMaybe<Array<AbilityBonusWhereInput>>;
  /** language_options edge predicates */
  ...
  nameNEQ?: InputMaybe<Scalars['String']['input']>;
  nameNotIn?: InputMaybe<Array<Scalars['String']['input']>>;
  not?: InputMaybe<SubraceWhereInput>;
  or?: InputMaybe<Array<SubraceWhereInput>>;
};
...
export type GetCharacterQuery = { __typename?: 'Query', node?: { __typename?: 'AbilityBonus' } | { __typename?: 'AbilityBonusChoice' } | { __typename?: 'AbilityScore' } | { __typename?: 'Alignment' } | { __typename?: 'Armor' } | { __typename?: 'Character', id: string, name: string, race: { __typename?: 'Race', id: string, indx: string }, class: { __typename?: 'Class', id: string, indx: string } } | { __typename?: 'Class' } | { __typename?: 'Coin' } | { __typename?: 'Condition' } | { __typename?: 'Cost' } | { __typename?: 'DamageType' } | { __typename?: 'Equipment' } | { __typename?: 'EquipmentEntry' } | { __typename?: 'Feat' } | { __typename?: 'Feature' } | { __typename?: 'Gear' } | { __typename?: 'Language' } | { __typename?: 'LanguageChoice' } | { __typename?: 'MagicSchool' } | { __typename?: 'Prerequisite' } | { __typename?: 'Proficiency' } | { __typename?: 'ProficiencyChoice' } | { __typename?: 'Property' } | { __typename?: 'Race' } | { __typename?: 'Rule' } | { __typename?: 'RuleSection' } | { __typename?: 'Skill' } | { __typename?: 'Subrace' } | { __typename?: 'Tool' } | { __typename?: 'Trait' } | { __typename?: 'Vehicle' } | { __typename?: 'Weapon' } | null };

export type GetCharactersQueryVariables = Exact<{ [key: string]: never; }>;


export type GetCharactersQuery = { __typename?: 'Query', characters: { __typename?: 'CharacterConnection', edges?: Array<{ __typename?: 'CharacterEdge', node?: { __typename?: 'Character', id: string, name: string, race: { __typename?: 'Race', id: string, indx: string }, class: { __typename?: 'Class', id: string, indx: string } } | null } | null> | null } };


export const GetCharacterDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetCharacter"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"characterId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"node"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"characterId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"InlineFragment","typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Character"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"race"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"indx"}}]}},{"kind":"Field","name":{"kind":"Name","value":"class"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"indx"}}]}}]}}]}}]}}]} as unknown as DocumentNode<GetCharacterQuery, GetCharacterQueryVariables>;
