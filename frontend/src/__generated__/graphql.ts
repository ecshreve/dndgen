...
export type GetRaceDetailsQuery = { __typename?: 'Query', races: Array<{ __typename?: 'Race', id: string, indx: string, name: string, ageDesc: string, alignmentDesc: string, size: RaceSize, sizeDesc: string, speed: number, languageDesc: string, startingProficiencies?: Array<{ __typename?: 'Proficiency', id: string, indx: string, name: string }> | null, startingProficiencyOptions?: { __typename?: 'ProficiencyChoice', id: string, desc: Array<string>, choose: number, proficiencies?: Array<{ __typename?: 'Proficiency', id: string, indx: string, name: string }> | null } | null }> };
