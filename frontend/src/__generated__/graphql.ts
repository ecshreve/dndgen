...
export type CharacterAbilityScoreFragmentFragment = { __typename?: 'CharacterAbilityScore', id: string, score: number, modifier: number, abilityScore: { __typename?: 'AbilityScore', id: string, indx: string, name: string }, characterSkills?: Array<{ __typename?: 'CharacterSkill', id: string, proficient: boolean, skill: { __typename?: 'Skill', id: string, indx: string, name: string } }> | null } & { ' $fragmentName'?: 'CharacterAbilityScoreFragmentFragment' };
