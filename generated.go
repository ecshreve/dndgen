...
"""Ordering options for EquipmentCategory connections"""
input EquipmentCategoryOrder {
  """The ordering direction."""
  direction: OrderDirection! = ASC
  """The field by which to order EquipmentCategories."""
  field: EquipmentCategoryOrderField!
}
"""Properties by which EquipmentCategory connections can be ordered."""
